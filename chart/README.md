...
[![Version: 1.1.2](https://img.shields.io/badge/Version-1.1.2-informational?style=flat-square)](https://github.com/HenriqZimer/xemu-helm-chart)
...
helm package chart/
helm install xemu ./xemu-1.1.2.tgz
```
